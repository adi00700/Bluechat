...
var euiCollapsibleNavGroupStyles = function euiCollapsibleNavGroupStyles(_ref) {
  ...
  return {
    ...
    dark: /*#__PURE__*/(0, _react.css)("background-color:", colorMode === 'DARK' ? (0, _services.shade)(euiTheme.colors.lightestShade, 0.5) : (0, _services.shade)(euiTheme.colors.darkestShade, 0.2), ";.euiCollapsibleNavGroup__title,.euiCollapsibleNavGroup__heading,.euiAccordion__iconButton{color:", euiTheme.colors.ghost, ";};label:dark;"),
    // Header padding
